...
HD_PWD='D:/Project/DD_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dd_project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dd_project.tcl
