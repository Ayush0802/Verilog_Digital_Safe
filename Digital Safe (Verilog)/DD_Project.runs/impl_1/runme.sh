...
HD_PWD='D:/Project/DD_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dd_project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dd_project.tcl -notrace
